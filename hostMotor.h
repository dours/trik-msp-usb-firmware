...
// the class MSPMotor transforms certain motor parameter changes to 
// an array of trivial commands (tmemoryCommand), which should be further
// sent to an MSP for execution
